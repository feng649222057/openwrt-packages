...
function index()
    ...
    entry({ "admin", "control", "appfilter" }, alias("admin", "control", "appfilter", "user_list"), _("App Filter"), 20).dependent = true
    entry({ "admin", "control", "appfilter", "user_list" }, arcombine(cbi("appfilter/user_list", { hideapplybtn = true, hidesavebtn = true, hideresetbtn = true }), cbi("appfilter/dev_status", { hideapplybtn = true, hidesavebtn = true, hideresetbtn = true })), _("User List"), 21).leaf = true
    ...
    entry({ "admin", "control", "appfilter", "time_setting" }, cbi("appfilter/time_setting"), _("Effective Time"), 24).leaf = true
    entry({ "admin", "control", "appfilter", "feature" }, cbi("appfilter/feature", { hideapplybtn = true, hidesavebtn = true, hideresetbtn = true }), _("App Feature"), 25).leaf = true
